...
:::::: div linked-codes
::: code iOS
如需移除黑名单相关监听器，可调用 [`removeUserListener`](https://doc.yunxin.163.com/messaging2/client-apis/jc0MTUyODY?platform=client#removeUserListener) 方法。
...
::: code iOS
```Objective-C
[[[NIMSDK sharedSDK] v2UserService] getBlockList:^(NSArray<NSString *> * _Nonnull blockList) {
    // 获取成功,处理黑名单列表
