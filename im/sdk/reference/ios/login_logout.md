...
- **添加监听**：[`addLoginListener`](https://doc.yunxin.163.com/messaging2/client-apis/TQ5NTUwNzQ?platform=client#addLoginListener)
    ...
    @end
    ```
- **移除监听**：[`removeLoginListener`](https://doc.yunxin.163.com/messaging2/client-apis/TQ5NTUwNzQ?platform=client#addLoginListener)
    ```Objective-C
...
- **添加监听**：[`addLoginDetailListener`](https://doc.yunxin.163.com/messaging2/client-apis/TQ5NTUwNzQ?platform=client#addLoginDetailListener)
    ...
    @end
    ```
- **移除监听**：[`removeLoginDetailListener`](https://doc.yunxin.163.com/messaging2/client-apis/TQ5NTUwNzQ?platform=client#removeLoginDetailListener)
    ```Objective-C
...
2. 如果您需要采用第三方服务器的动态登录扩展数据或动态 Token 进行鉴权，那么需要在调用 `login` 方法登录时将 `authType` 设置为 2，并设置获取动态登录扩展数据 `loginExtensionProvider` 回调和获取动态 Token 回调 `tokenProvider`，SDK 会在登录过程中获取第三方回调的动态扩展数据和动态 Token。
    ...
    **示例代码**：
    ...
    ::: code iOS
    ```Objective-C
    @interface YourLoginExtensionProvider : NSObject <V2NIMLoginExtensionProvider>
...
API | 说明
--- | ---
[`addLoginListener`](https://doc.yunxin.163.com/messaging2/client-apis/TQ5NTUwNzQ?platform=client#addLoginListener) | 注册登录状态监听器
[`removeLoginListener`](https://doc.yunxin.163.com/messaging2/client-apis/TQ5NTUwNzQ?platform=client#addLoginListener) | 取消注册登录状态监听器
[`addLoginDetailListener`](https://doc.yunxin.163.com/messaging2/client-apis/TQ5NTUwNzQ?platform=client#addLoginDetailListener) | 注册登录连接状态监听器
[`removeLoginDetailListener`](https://doc.yunxin.163.com/messaging2/client-apis/TQ5NTUwNzQ?platform=client#removeLoginDetailListener) | 取消注册登录连接状态监听器
[`login`](https://doc.yunxin.163.com/messaging2/client-apis/TQ5NTUwNzQ?platform=client#login) | 登录 IM
[`logout`](https://doc.yunxin.163.com/messaging2/client-apis/TQ5NTUwNzQ?platform=client#logout) | 登出 IM
[`getLoginStatus`](https://doc.yunxin.163.com/messaging2/client-apis/TQ5NTUwNzQ?platform=client#getLoginStatus) | 获取当前登录状态
[`tokenProvider`](https://doc.yunxin.163.com/messaging2/client-apis/DAxNjk0Mzc?platform=client#V2NIMTokenProvider) | 获取动态登录 token
[`loginExtensionProvider`](https://doc.yunxin.163.com/messaging2/client-apis/DAxNjk0Mzc?platform=client#V2NIMLoginExtensionProvider) | 获取登录扩展信息 loginExtension
[`getLoginClients`](https://doc.yunxin.163.com/messaging2/client-apis/DAxNjk0Mzc?platform=client#getLoginClients) | 获取多端登录列表信息
[`getCurrentLoginClient`](https://doc.yunxin.163.com/messaging2/client-apis/DAxNjk0Mzc?platform=client#getCurrentLoginClient) | 获取当前登录终端的信息
:::
::::::
