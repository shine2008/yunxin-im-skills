...
:::::: div linked-codes
::: code Flutter
调用 [`listen`](https://doc.yunxin.163.com/messaging2/client-apis/jA3NjI0ODQ?platform=client#listen) 方法注册用户状态订阅相关监听器，监听用户状态变更事件。
...
:::::: div linked-codes
::: code Flutter
如需移除用户相关监听器，可调用 [`cancel`](https://doc.yunxin.163.com/messaging2/client-apis/jA3NjI0ODQ?platform=client#cancel) 方法。
